...
function App() {
  ...
  <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between rounded-full border border-white/10 bg-[#050816]/55 px-6 backdrop-blur-2xl">
    ...
    <div className="hidden md:flex items-center gap-7 text-sm text-gray-300">
      ...
      <a href="#kimler-icin" className="hover:text-white transition">Kimler İçin?</a>
...
<div className="relative h-[650px] -mt-10 flex items-center justify-center [perspective:1200px]">
  ...
  />
      ...
      {/* Özellikler Bölümü */}
<section className="relative z-10 w-full overflow-hidden py-32">
...
<section className="relative z-10 w-full overflow-hidden py-40">
  {/* Arka plan efektleri */}
  ...
  {/* Dev yazı */}
  <div className="pointer-events-none absolute left-1/2 top-10 -translate-x-1/2 text-[140px] md:text-[220px] font-black text-white/[0.04]">
    FORMUP+
  </div>
  ...
  <div className="relative max-w-5xl mx-auto px-8 text-center">
    ...
    <div className="flex flex-wrap justify-center gap-3 mb-10">
      ...
      {[
        ...
        <span
          key={item}
          className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-sm text-gray-300 backdrop-blur-xl"
        >
          {item}
        </span>
      ))}
    ...
    <h2 className="text-5xl md:text-7xl font-black leading-tight">
      FormUp+ ile
      <br />
      salonunuzu daha verimli yönetin.
    </h2>

    <p className="mt-8 max-w-2xl mx-auto text-lg text-gray-400">
      Demo talep etmek, detaylı bilgi almak veya FormUp+'ın
      işletmenize nasıl uyarlanabileceğini öğrenmek için bizimle iletişime geçin.
    </p>

    <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">

      <button className="group rounded-full bg-cyan-400 px-8 py-4 font-semibold text-black hover:bg-cyan-300 transition flex items-center justify-center gap-2">
        Demo Talep Et
        <ArrowRight
          size={18}
      ...
      <button className="rounded-full border border-white/20 px-8 py-4 font-semibold hover:bg-white hover:text-black transition">
        İletişime Geç
      </button>
